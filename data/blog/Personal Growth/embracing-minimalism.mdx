...
social:
  summary: 'Minimalism is more than just a buzzword—it''s a conscious decision to focus on what''s truly important and remove anything that distracts from it.'
  hashtags: ''
---
