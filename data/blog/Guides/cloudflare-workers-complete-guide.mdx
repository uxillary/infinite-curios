...
social:
  summary: 'Cloudflare Workers let you run JavaScript at the network edge, closer to your users, without managing servers.'
  hashtags: ''
---
...
The `dev` command spins up a local server that simulates the Cloudflare environment. Navigate to [http://localhost:8787](http://localhost:8787) to test your Worker.
