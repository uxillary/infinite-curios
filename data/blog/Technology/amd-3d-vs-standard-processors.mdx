...
social:
  summary: 'AMD''s recent lineup of chips with "3D" in the name refers to the inclusion of 3D V-Cache, a technique that stacks extra L3 cache vertically on top of the compute die.'
  hashtags: ''
---
